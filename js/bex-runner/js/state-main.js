var StateMain = {
    preload: function() {
        game.load.image("sidewalk", "../../images/web-games/bex-runner/sidewalk.png");
        game.load.atlasJSONHash('hero', '../../images/web-games/bex-runner/BexRunnerSprite.png', '../../images/BexRunnerSprite.json');
        game.load.image("bar", "../../images/web-games/bex-runner/powerbar.png");
        game.load.image("toybox", "../../images/web-games/bex-runner/toyWrapper.png");
        game.load.atlasJSONHash("toy", "../../images/web-games/bex-runner/90sToySprite.png", "../../images/web-games/bex-runner/90sToySprite.json");
        game.load.image("playAgain", "../../images/web-games/bex-runner/playAgain.png");
        game.load.image("clouds", "../../images/web-games/bex-runner/clouds.png");
        //Background Images
        game.load.image("background", "../../mages/web-games/bex-runner/background.png");
        game.load.image("city1", "../../images/web-games/bex-runner/city1.png");
        game.load.image("trees", "../../images/web-games/bex-runner/trees.png");
    },
